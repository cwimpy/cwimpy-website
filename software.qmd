...
For Typst, clone and `#import "ab-annotate.typ": annotated-bib` pending Typst Universe publication. A working Quarto example lives in [`examples/quarto/`](https://github.com/cwimpy/ab-annotate/tree/main/examples/quarto).
